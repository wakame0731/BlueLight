...
use pocketmine\level\generator\normal\eardbiome\BiomeSelector;
use pocketmine\level\generator\Generator;
use pocketmine\level\generator\noise\Simplex;
use pocketmine\level\generator\object\OreType;
use pocketmine\level\generator\populator\EardGroundCover as GroundCover;
...
/*			if($rainfall < 0.25){
		...
		$ores->setOreTypes([
			...
			new OreType(BlockFactory::get(Block::EMERALD_ORE), 2, 4, 0, 128),
			...
			for($z = 0; $z < 16; ++$z){
				...
				for($y = 0; $y < 256; ++$y){
					...
					if($noiseValue > 0){
						...
						if($y == $this->waterHeight && $biome->getId() == Biome::ICE_PLAINS){
